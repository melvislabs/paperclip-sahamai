...
import { RegisterBodySchema, LoginBodySchema, RefreshBodySchema, CreateApiKeyBodySchema, AuthResponseSchema, ApiKeyResponseSchema, ErrorSchema, ValidationErrorSchema } from './schemas.js';
const roleMap = {
    admin: 'ADMIN',
    user: 'USER',
    service: 'SERVICE'
...
export function requireRole(requiredRole) {
    return function roleMiddleware(request, reply) {
        if (!request.user) {
...
export function protectRoutes(app, routes, options) {
